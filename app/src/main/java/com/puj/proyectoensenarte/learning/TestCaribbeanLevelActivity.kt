...
class TestCaribbeanLevelActivity : AppCompatActivity() {
    ...
    private val lessonName = "Test Región Caribe"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_test_caribbean_level)
    ...
    private fun loadExamQuestions() {
        ...
        val lessonIds = listOf("lesson4", "lesson5", "lesson6")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            Log.d("TestCaribbeanLevelActivity", "Respuesta recibida: $correctAnswer") // Verificar el valor recibido
            ...
            failCount++
            Toast.makeText(this, "Respuesta incorrecta. Intentos restantes: ${maxFails - failCount}", Toast.LENGTH_SHORT).show()
            Log.d("TestCaribbeanLevelActivity", "No se recibió respuesta válida o respuesta incorrecta por defecto")
